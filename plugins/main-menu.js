...
const defaultMenu = {
  before: `╭̟̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩.....․⁀⸱⁀⸱︵૰⳹․㊪․⳼૰︵⸱⁀⸱⁀․.....╮̟̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩
...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
  try {
    ...
    const pp = await conn.profilePictureUrl(who, 'image').catch(_ => 'https://telegra.ph/file/c46f4f5e17641252482a9.jpg')
