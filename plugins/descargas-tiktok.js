...
m.react('🕒') 
    ...
    const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: packname, body: team, thumbnail: icons, sourceUrl: yt}, mentionedJid: [m.sender]}}}, aa);
