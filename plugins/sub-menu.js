...
await conn.reply(m.chat, '⏱ _Cargando sub menu_', m )
  m.react("✨");
...
┝╾─────────────────╯
┆⏱ *en desarrollo*
┆Este Sub menu esta en fase prueba 
╰ׄ┄ׅׄ─ׅׄ┄ׅׄ─ׂׅ┄ׅׄ─ׂׅ┄ׅׄ─ׅׄ┄ׅׄ─ׂׅ┄ׅׄ─ׂׅ┄ׅׄ─ׅׄ─ׂׅ┄ׅׄ─ׂ╯`;

  let listSections = [];

  listSections.push({
    title: `AVISO: EL BOT TODAVIA ESTA EN CREACION`,
    rows: [
      {
        header: "allmenu",
        title: "Menu Completo",
